...
namespace DevAzt.FormsX.Droid.Device.Sensors
{
    public class Geolocator : Java.Lang.Object, ILocationListener
    {
        ...
        private long _timeupdate { get; set; }
        public Geolocator(Context _context, long timeupdateinmilliseconds) : base()
		{
            _timeupdate = timeupdateinmilliseconds;
			...
			if (acceptableLocationProviders.Any())
			{
				...
				_locationManager.RequestLocationUpdates(_locationProvider, _timeupdate, 0, this);
                IsGPSStarted = true;
            }
		}
